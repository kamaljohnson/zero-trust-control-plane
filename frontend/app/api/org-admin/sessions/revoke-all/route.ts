...
/**
 * POST /api/org-admin/sessions/revoke-all
 * Body: { org_id, user_id }. Revokes all sessions for the user in the org. Requires org admin or owner.
 */
export async function POST(request: NextRequest) {
  ...
  try {
    await orgAdmin.revokeAllSessionsForUser(token, orgId, userId);
